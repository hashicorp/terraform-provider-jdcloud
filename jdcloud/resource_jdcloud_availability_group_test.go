...
func TestAccJDCloudAvailabilityGroup_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: generateAGConfig("terraform_ag_test", "This is an ag generated by terraform"),
				Check: resource.ComposeTestCheckFunc(
					testAccIfAgExists("jdcloud_availability_group.terraform_ag", &agId),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "availability_group_name", "terraform_ag_test"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "az.#", "1"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "instance_template_id", "it-fpxvfdch26"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "description", "This is an ag generated by terraform"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "ag_type", "kvm"),

				),
			},
			{
				Config: generateAGConfig("another_ag", "Same ag just different name"),
				Check: resource.ComposeTestCheckFunc(
					testAccIfAgExists("jdcloud_availability_group.terraform_ag", &agId),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "availability_group_name", "another_ag"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "az.#", "1"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "instance_template_id", "it-fpxvfdch26"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "description", "Same ag just different name"),
					resource.TestCheckResourceAttr("jdcloud_availability_group.terraform_ag", "ag_type", "kvm"),
...
func generateAGConfig(name, description string) string {
