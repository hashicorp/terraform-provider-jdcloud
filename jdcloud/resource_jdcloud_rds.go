...
func resourceJDCloudRDS() *schema.Resource {

	return &schema.Resource{
		Create: resourceJDCloudRDSCreate,
		Read:   resourceJDCloudRDSRead,
		Update: resourceJDCloudRDSUpdate,
		Delete: resourceJDCloudRDSDelete,
...
func resourceJDCloudRDSCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceJDCloudRDSRead(d,meta)
}

func resourceJDCloudRDSRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceJDCloudRDSUpdate(d *schema.ResourceData, meta interface{}) error {
