		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "az", "cn-north-1a"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "instance_name", "TerraformName1"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "instance_type", "c.n1.large"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "image_id", "bba85cab-dfdc-4359-9218-7a2de429dd80"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "description", "terraform testing create"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "subnet_id", "subnet-j8jrei2981"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "network_interface_name", "jdcloud"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "primary_ip", "10.0.5.0"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "security_group_ids.#", "1"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "elastic_ip_bandwidth_mbps", "10"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "elastic_ip_provider", "bgp"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "system_disk.#", "1"),
					resource.TestCheckNoResourceAttr("jdcloud_instance.DevOps", "data_disk"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccIfInstanceExists("jdcloud_instance.DevOps", &instanceId),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "az", "cn-north-1a"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "instance_name", "TerraformName2"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "instance_type", "c.n1.large"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "image_id", "bba85cab-dfdc-4359-9218-7a2de429dd80"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "description", "terraform testing update"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "subnet_id", "subnet-j8jrei2981"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "network_interface_name", "jdcloud"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "primary_ip", "10.0.5.0"),
					resource.TestCheckResourceAttr("jdcloud_instance.DevOps", "security_group_ids.#", "1"),
